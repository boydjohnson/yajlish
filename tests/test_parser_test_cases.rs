...
static PATH: &str = "fixtures";

#[test]
#[ignore]
fn test_difficult_json_with_comments() {
    test_fixture(PATH, DIFFICULT_JSON_WITH_COMMENTS);
}

#[test]
#[ignore]
fn test_simple_json_with_comments() {
    test_fixture(PATH, SIMPLE_JSON_WITH_COMMENTS);
}

#[test]
#[ignore]
fn test_false_then_garbage() {
    test_fixture(PATH, FALSE_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_null_then_garbage() {
    test_fixture(PATH, NULL_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_true_then_garbage() {
    test_fixture(PATH, TRUE_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_eof() {
    test_fixture(PATH, EOF);
}

#[test]
#[ignore]
fn test_am_integers() {
    test_fixture(PATH, AM_INTEGERS);
}

#[test]
#[ignore]
fn test_am_multiple() {
    test_fixture(PATH, AM_MULTIPLE);
}

#[test]
#[ignore]
fn test_stuff() {
    test_fixture(PATH, STUFF);
}

#[test]
#[ignore]
fn test_array_open() {
    test_fixture(PATH, ARRAY_OPEN);
}

#[test]
#[ignore]
fn test_eof_str() {
    test_fixture(PATH, EOF_STR);
}

#[test]
#[ignore]
fn test_map_open() {
    test_fixture(PATH, MAP_OPEN);
}

#[test]
#[ignore]
fn test_partial_ok() {
    test_fixture(PATH, PARTIAL_OK);
}

#[test]
#[ignore]
fn test_array() {
    test_fixture(PATH, ARRAY);
}

#[test]
#[ignore]
fn test_array_close() {
    test_fixture(PATH, ARRAY_CLOSE);
}

#[test]
#[ignore]
fn test_bignums() {
    test_fixture(PATH, BIGNUMS);
}

#[test]
#[ignore]
fn test_bogus_char() {
    test_fixture(PATH, BOGUS_CHAR);
}

#[test]
#[ignore]
fn test_codepoints_from_unicode() {
    test_fixture(PATH, UNICODE_CODEPOINTS);
}

#[test]
fn test_deep_arrays() {
    test_fixture(PATH, DEEP_ARRAYS);
}

#[test]
#[ignore]
fn test_difficult_test_case() {
    test_fixture(PATH, DIFFICULT_TEST_CASE);
}

#[test]
#[ignore]
fn test_doubles() {
    test_fixture(PATH, DOUBLES);
}

#[test]
#[ignore]
fn test_doubles_in_array() {
    test_fixture(PATH, DOUBLES_IN_ARRAY);
}

#[test]
fn test_empty_array() {
    test_fixture(PATH, EMPTY_ARRAY);
}

#[test]
fn test_empty_string() {
    test_fixture(PATH, EMPTY_STRING);
}

#[test]
#[ignore]
fn test_escaped_bulgarian() {
    test_fixture(PATH, ESCAPED_BULGARIAN);
}

#[test]
#[ignore]
fn test_escaped_foobar() {
    test_fixture(PATH, ESCAPED_FOO_BAR);
}

#[test]
fn test_false() {
    test_fixture(PATH, FALSE);
}

#[test]
#[ignore]
fn test_fg_false_then_garbage() {
    test_fixture(PATH, FG_FALSE_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_issue_7() {
    test_fixture(PATH, FG_ISSUE_7);
}

#[test]
#[ignore]
fn test_fg_null_then_garbage() {
    test_fixture(PATH, FG_NULL_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_fg_true_then_garbage() {
    test_fixture(PATH, FG_TRUE_THEN_GARBAGE);
}

#[test]
#[ignore]
fn test_four_byte_utf8() {
    test_fixture(PATH, FOUR_BYTE_UTF8);
}

#[test]
#[ignore]
fn test_high_overflow() {
    test_fixture(PATH, HIGH_OVERFLOW);
}

#[test]
fn test_integers() {
    test_fixture(PATH, INTEGERS);
}

#[test]
#[ignore]
fn test_invalid_utf8() {
    test_fixture(PATH, INVALID_UTF8);
}

#[test]
#[ignore]
fn test_isolated_surrogate_marker() {
    test_fixture(PATH, ISOLATED_SURROGATE_MARKER);
}

#[test]
#[ignore]
fn test_leading_zeros_in_number() {
    test_fixture(PATH, LEADING_ZERO_IN_NUMBER);
}

#[test]
#[ignore]
fn test_lonely_minus_sign() {
    test_fixture(PATH, LONELY_MINUS_SIGN);
}

#[test]
#[ignore]
fn test_lonely_number() {
    test_fixture(PATH, LONELY_NUMBER);
}

#[test]
#[ignore]
fn test_low_overflow() {
    test_fixture(PATH, LOW_OVERFLOW);
}

#[test]
#[ignore]
fn test_map_close() {
    test_fixture(PATH, MAP_CLOSE);
}

#[test]
#[ignore]
fn test_missing_integer_after_decimal_point() {
    test_fixture(PATH, MISSING_INTEGER_AFTER_DECIMAL_POINT);
}

#[test]
#[ignore]
fn test_missing_integer_after_exponent() {
    test_fixture(PATH, MISSING_INTEGER_AFTER_EXPONENT);
}

#[test]
#[ignore]
fn test_multiple() {
    test_fixture(PATH, MULTIPLE);
}

#[test]
#[ignore]
fn test_non_utf8_char_in_string() {
    test_fixture(PATH, NON_UTF8_CHAR_IN_STRING);
}

#[test]
#[ignore]
fn test_partial_bad() {
    test_fixture(PATH, PARTIAL_BAD);
}

#[test]
fn test_null() {
    test_fixture(PATH, NULL);
}

#[test]
#[ignore]
fn test_nulls_and_bools() {
    test_fixture(PATH, NULLS_AND_BOOLS);
}

#[test]
#[ignore]
fn test_simple() {
    test_fixture(PATH, SIMPLE);
}

#[test]
#[ignore]
fn test_simple_with_comments() {
    test_fixture(PATH, SIMPLE_WITH_COMMENTS);
}

#[test]
#[ignore]
fn test_string_invalid_escape() {
    test_fixture(PATH, STRING_INVALID_ESCAPE);
}

#[test]
#[ignore]
fn test_invalid_hex_char() {
    test_fixture(PATH, STRING_INVALID_HEX);
}

#[test]
#[ignore]
fn test_string_with_escapes() {
    test_fixture(PATH, STRING_WITH_ESCAPES);
}

#[test]
#[ignore]
fn test_string_with_invalid_newline() {
    test_fixture(PATH, STRING_WITH_INVALID_NEWLINE);
}

#[test]
#[ignore]
fn test_three_byte_utf8() {
    test_fixture(PATH, THREE_BYTE_UTF8);
}

#[test]
fn test_true() {
    test_fixture(PATH, TRUE);
}

#[test]
#[ignore]
fn test_unescaped_bulgarian() {
    test_fixture(PATH, UNESCAPED_BULGARIAN);
}

#[test]
#[ignore]
fn test_zerobyte() {
    test_fixture(PATH, ZEROBYTE);
}
